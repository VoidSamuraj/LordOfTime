...
class FragmentDateChartElement : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        FragmentDateChartElement.context=context
        week1 = first_week
        week2 = second_week
        week3 = third_week
        week4 = fourth_week
    ...
    companion object {
        ...
        fun createDaysCalendarChart(monthCalendar: Calendar, isMondayFirstDay:Boolean=false){
            ...
            val list: java.util.ArrayList<java.util.ArrayList<NTuple4<Int, Float, Boolean, Int>?>> =
                java.util.ArrayList()
            ...
            var day=1
            var started=false
            var localList: java.util.ArrayList<NTuple4<Int, Float, Boolean, Int>?>
        ...
        fun createWeekCalendarChart(monthCalendar: Calendar, isMondayFirstDay:Boolean=false){
            ...
            fun setWeekAdapter(recyclerView:RecyclerView,arrayList: java.util.ArrayList<NTuple4<Int, Float, Boolean, Int>?>) {
                setAdapterManager(
                    recyclerView,
            ...
            setWeekAdapter(week3, java.util.ArrayList())
            setWeekAdapter(week4, java.util.ArrayList())
            setWeekAdapter(week5, java.util.ArrayList())
            setWeekAdapter(week6, java.util.ArrayList())
        }

        fun createMonthCalendarChart(monthCalendar: Calendar, isMondayFirstDay:Boolean=false){
            ...
            fun setMonthAdapter(recyclerView:RecyclerView,arrayList: java.util.ArrayList<NTuple4<Int, Float, Boolean, Int>?>) {
                setAdapterManager(
                    recyclerView,
                    CalendarAdapter(arrayList),
                    LinearLayoutManager(context,RecyclerView.HORIZONTAL,false)
            ...
            fun fillLine(start:Int,end:Int): java.util.ArrayList<NTuple4<Int, Float, Boolean, Int>?> {
                val localList: java.util.ArrayList<NTuple4<Int, Float, Boolean, Int>?> =
                    java.util.ArrayList()
            ...
            setMonthAdapter(week4, java.util.ArrayList())
            setMonthAdapter(week5, java.util.ArrayList())
            setMonthAdapter(week6, java.util.ArrayList())
        }
